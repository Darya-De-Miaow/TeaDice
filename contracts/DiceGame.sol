...
// This is the main smart contract for TeaDice, deployed on the Tea Sepolia EVM-compatible testnet.
contract DiceGame {
    ...
    // This event is emitted every time a player rolls - the frontend listens for it to update the UI.
    ...
    function rollDice() public returns (uint256) {
        // This generates a pseudo-random number using keccak256 hashing of block data.
